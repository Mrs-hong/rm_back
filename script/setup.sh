...
# =============================================================================
# 说明：
#   以 root 权限依次执行系统库安装、数据库初始化、nginx 卸载/安装/配置、
#   SCM 及服务安装，共 6 个步骤，任一步骤失败则终止。
...
# 步骤3/6：卸载旧 nginx（uninstall_nginx.sh 含交互式确认，通过管道传入 "y"）
...
# 步骤5/6：部署 nginx 配置
run_step 5 "部署 nginx 配置" "bash '${SCRIPT_DIR}/nginx/deploy_config.sh'"

# 步骤6/6：安装 SCM 及服务
run_step 6 "安装 SCM 及服务" "bash '${SCRIPT_DIR}/scm_and_soft/install.sh'"
