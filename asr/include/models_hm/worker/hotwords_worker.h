...
#ifndef QIFENG_FRAMEWORK_INCLUDE_MODELS_HM_WORKER_HOTWORDS_WORKER_H
#define QIFENG_FRAMEWORK_INCLUDE_MODELS_HM_WORKER_HOTWORDS_WORKER_H
...
namespace qifeng {
     ...
     * @brief 热词模型工作者类 (TCIM 版本)，继承自 ModelWorker 基类
     */
...
#endif  // QIFENG_FRAMEWORK_INCLUDE_MODELS_HM_WORKER_HOTWORDS_WORKER_H
