...
namespace {
    ...
    DatabaseConfig MakeMySQLConfig() {
        ...
        cfg.rootDir = TEST_TMP_BASE + "/mysql/bin";
    ...
    DatabaseConfig MakeOpenGaussConfig() {
        ...
        cfg.rootDir = TEST_TMP_BASE + "/opengauss/bin";
...
TEST(DatabaseInitTest, GetConfig) {
    ...
    EXPECT_EQ(returnedCfg.rootDir, cfg.rootDir);
