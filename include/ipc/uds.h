...
namespace qifeng::scm {
    ...
    public:
         ...
         */
        explicit UdsWrapper(UdsMode mode, const std::string &socketPath, int maxConnections = 1, int socketMode = 0666);
         ...
         * CLIENT模式：创建socket
         * 重复调用会先关闭之前的资源再重新初始化
         * @return 初始化结果 code:0表示成功，其他表示失败，msg:错误信息或成功信息
         */
        [[nodiscard]] ResultMsg Initialize();
         ...
         * @return 连接结果 code:0表示成功，其他表示失败，msg:错误信息或成功信息
         */
        [[nodiscard]] ResultMsg Connect();
