...
namespace qifeng::scm {
    ...
    /**
     * @brief 共享依赖上下文
     * @details 持有所有领域管理器的 shared_ptr，由 ServiceContainer::Init() 构造后填充。
     *          handler 通过此上下文直接访问子服务，无需经过 ServiceContainer 门面。
     ...
     *          在 ServiceContainer::Init() 中按依赖顺序构造后填充。
    ...
    struct ServiceContext {
        ...
        // 领域服务（由 ServiceContainer::Init() 构造后填充）
