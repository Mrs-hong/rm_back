...
namespace qifeng::scm {
     ...
     * 提供完整的服务生命周期管理功能，包括安装、启动、停止、重启、卸载等操作。
     * @details nginx/模型/升级等领域逻辑已提取到 NginxManager/ModelManager/UpgradeService，
     *          通过 GetServiceContext() 共享依赖上下文，并通过 public 共享辅助方法供各领域管理器调用。
     */
    ...
    public:
        ...
        /**
         * @brief 获取共享依赖上下文（供领域管理器使用）
         * @return ServiceContext 包含 configLoader/fileManager/dbusManager 的 shared_ptr
         */
